...
export default class BulkChange extends React.PureComponent<Props, State> {
  ...
  getSelectedProfile = () => {
    return (this.props.profile && this.props.referencedProfiles[this.props.profile]) || undefined;
  };

  closeModal = () => {
    this.setState({ action: undefined, modal: false });
  };
  ...
  handleActivateClick = (event: React.SyntheticEvent<HTMLAnchorElement>) => {
    ...
    this.closeDropdown();
    this.setState({ action: 'activate', modal: true });
  };
  ...
  render() {
    ...
    const allowActivateOnProfile = canChangeProfile && this.props.activation === false;
    const allowDeactivateOnProfile = canChangeProfile && this.props.activation === true;
            ...
            return (
              <div className={classNames('pull-left dropdown', { open })}>
                ...
                <ul className="dropdown-menu">
                  ...
                  <li>
                    <a href="#">{translate('coding_rules.deactivate_in')}…</a>
                  </li>
